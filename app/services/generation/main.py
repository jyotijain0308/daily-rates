...
from app.services.generation.config import PRODUCTS_DATA_FILE, OUTPUT_PPT_FILE, COUNTRY_CURRENCY_CODES
from app.services.generation.product_data import ProductDataLoader, ProductData
...
from app.services.generation.error_handling import (
