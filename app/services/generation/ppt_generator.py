...
class PPTGenerator:
    ...
    def add_country_title_slide(self, country_name: str, current_date: datetime = None):
        ...
        self._add_image_or_text(
            slide, self.company_logo_image, self.company_name,
    ...
    def add_product_slide(self, product: ProductData, slide_number: int = None):
        ...
        title_frame.word_wrap = True
        p = title_frame.paragraphs[0]
        p.text = f"{product.product_name} {product.weight_kg} {product.packing}"
        p.font.size = Pt(40)
        p.font.bold = True
        p.font.color.rgb = COLORS["primary"]
        p.font.name = FONTS["title"]
        ...
        p.text = f"Price: {self.rate_display_format.format(product.price_aed)}"
        p.font.size = Pt(40)
        p.font.bold = True
    ...
    def add_thank_you_slide(self, country_name: str, exchange_rate: Optional[float] = None,
        ...
        self._add_image_or_text(
            slide, self.destination_logo_image, "UAE",
        ...
        p_website.text = self.company_website
