...
const dashboardSharePlatforms = [
    { key: 'youtube', label: 'YouTube', statusMethod: 'getYouTubeStatus', publishMethod: 'publishYouTube', statusEl: document.getElementById('shareYouTubeStatus'), buttonEl: document.getElementById('publishYouTubeBtn'), messageEl: document.getElementById('youtubePublishMessage'), buttonText: 'Publish to YouTube', setupMessage: 'Add YouTube app keys in Company settings, then connect YouTube.', disconnectedMessage: 'Connect YouTube in Company settings first.', titleLimit: 100, extraPayload: () => ({ privacy_status: dashboardSharePostVisibility.value }) },
    { key: 'facebook', label: 'Facebook Page', statusMethod: 'getFacebookStatus', publishMethod: 'publishFacebook', statusEl: document.getElementById('shareFacebookStatus'), buttonEl: document.getElementById('publishFacebookBtn'), messageEl: document.getElementById('facebookPublishMessage'), buttonText: 'Publish to Facebook Page', setupMessage: 'Add Facebook app keys in Company settings, then connect Facebook.', disconnectedMessage: 'Connect Facebook in Company settings first.' },
    { key: 'instagram', label: 'Instagram', statusMethod: 'getInstagramStatus', publishMethod: 'publishInstagram', statusEl: document.getElementById('shareInstagramStatus'), buttonEl: document.getElementById('publishInstagramBtn'), messageEl: document.getElementById('instagramPublishMessage'), buttonText: 'Publish to Instagram', setupMessage: 'Add Public base URL in Company settings and connect a linked Instagram account.', disconnectedMessage: 'Connect Facebook Page with Instagram in Company settings first.', isReady: status => Boolean(status.facebook_connected && status.public_base_url_configured && status.connected) },
    { key: 'x', label: 'X', statusMethod: 'getXStatus', publishMethod: 'publishX', statusEl: document.getElementById('shareXStatus'), buttonEl: document.getElementById('publishXBtn'), messageEl: document.getElementById('xPublishMessage'), buttonText: 'Publish to X', setupMessage: 'Add X app keys in Company settings, then connect X.', disconnectedMessage: 'Connect X in Company settings first.' },
    { key: 'linkedin_personal', label: 'LinkedIn Profile', statusMethod: 'getLinkedInPersonalStatus', publishMethod: 'publishLinkedInPersonal', statusEl: document.getElementById('shareLinkedInPersonalStatus'), buttonEl: document.getElementById('publishLinkedInPersonalBtn'), messageEl: document.getElementById('linkedinPersonalPublishMessage'), buttonText: 'Publish to LinkedIn Profile', setupMessage: 'Add LinkedIn app keys in Company settings, then connect LinkedIn personal profile.', disconnectedMessage: 'Connect LinkedIn personal profile in Company settings first.', titleLimit: 200, extraPayload: () => ({ visibility: dashboardSharePostVisibility.value === 'public' ? 'PUBLIC' : 'CONNECTIONS' }) },
    { key: 'linkedin_page', label: 'LinkedIn Page', statusMethod: 'getLinkedInPageStatus', publishMethod: 'publishLinkedInPage', statusEl: document.getElementById('shareLinkedInStatus'), buttonEl: document.getElementById('publishLinkedInBtn'), messageEl: document.getElementById('linkedinPublishMessage'), buttonText: 'Publish to LinkedIn Page', setupMessage: 'Add LinkedIn app keys in Company settings, then connect LinkedIn Page.', disconnectedMessage: 'Connect LinkedIn Page in Company settings first.', titleLimit: 200, extraPayload: () => ({ visibility: dashboardSharePostVisibility.value === 'public' ? 'PUBLIC' : 'CONNECTIONS' }) },
];
